...
function get_settings_fields() {
	return array(
		...
		array(
			'desc'              => __( '<strong>Billing Address Book Limit</strong></p><p class="description">This sets the maximum number of billing addresses that each user can save. Set to 0 for unlimited.', 'woo-address-book' ),
		...
		array(
			'desc'              => __( '<strong>Shipping Address Book Limit</strong></p><p class="description">This sets the maximum number of shipping addresses that each user can save. Set to 0 for unlimited.', 'woo-address-book' ),
